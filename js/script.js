...
const studyData = [
    ...
    { cat: "I. 한자 (음과 뜻)", q: "友", a: "벗 우" }, { cat: "I. 한자 (음과 뜻)", q: "利", a: "이로울, 날카롭다 리" }, { cat: "I. 한자 (음과 뜻)", q: "結", a: "맺을 결" },
    ...
    { cat: "I. 한자 (음과 뜻)", q: "晝", a: "낮 주" }, { cat: "I. 한자 (음과 뜻)", q: "守", a: "지키다 수" }, { cat: "I. 한자 (음과 뜻)", q: "恩", a: "은혜 은" },
    ...
    { cat: "II. 어휘 (독음)", q: "強風", a: "강풍" }, { cat: "II. 어휘 (독음)", q: "寒波", a: "한파" }, { cat: "II. 어휘 (독음)", q: "大雪", a: "대설" },
    { cat: "II. 어휘 (독음)", q: "街村", a: "가촌" },
    ...
    { cat: "III. 성어", q: "朝三暮四", a: "조삼모사" }, { cat: "III. 성어", q: "五十步百步", a: "오십보백보" },
